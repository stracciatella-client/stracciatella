...
public class SodiumCompat {
    ...
    public static OptionPage config() {
        ...
        groups.add(OptionGroup
                .createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, configStorage).setName(Component.translatable("config.anonymous-modlist.sodium")).setTooltip(Component.translatable("config.anonymous-modlist.tooltip")).setBinding(ConfigHandler::setAnonymousModlist, ConfigHandler::isAnonymousModlistEnabled).setControl(TickBoxControl::new).build()).build());
        ...
        //         .build());
        //
        return new OptionPage(Component.translatable("config.anonymous-modlist.sodium"), ImmutableList.copyOf(groups));
    }
}
