...
import static net.stracciatella.Stracciatella.*;
...
public class SystemClassLoaderHack {
    ...
    static {
        try {
            systemClassLoaderInjectionsDirectory = Stracciatella.instance().service(Path.class, INTERNAL_DIRECTORY).resolve("system_injections");
